...
## Project Structure
    ...
    ├── testapiautoteammem_113999  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_113999`
...
2. Clone this repo and `cd testapiautoteammem_113999`
